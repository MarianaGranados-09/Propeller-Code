...
#Use RS232(RCV=PIN_B3, XMIT=PIN_B2, Baud=9600, Bits=8, Stream = BTHMOTOR, ERRORS)
...
Void main()
{
   ...
   while(TRUE)
   {
      ...
      //delay_ms(5000);
      if(flag == 1 && motor == 'a' && condicionMotor == 2)
      {
...
void motorGiro()
{
  if(kbhit(BTHMOTOR))
        {
         //Evaluar en que condicion esta el motor
            ...
            {
               fprintf(TTL, "El motor esta apagado\r\n");
               condicionMotor = 2;
            }
