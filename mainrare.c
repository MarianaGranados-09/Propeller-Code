//Exchanging code algorithm to store word
#Include <18F4550.h>
...
Void main()
{
   ...
   PORTD=0x00;
   //Delay_ms(200);
   Limpiar_palabra(); //cleaning word[100] buffer
   ...
   while(true)
   {
      ...
      //En este tramo de tiempo se enciende el motor
      //En el momento en el que se enciende el motor, le llega al bth una E
      while(!kbhit());
      Motor = getc(BTH);
      //El motor enciende
      if(Motor == 'E')
